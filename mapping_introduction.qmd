...
knitr::include_graphics(here("mapping_demo", "images", "intro_me.jpg"))
```
:::
...
knitr::include_graphics(here("mapping_demo", "images", "twitter_tidy.png"))
```
:::
...
knitr::include_graphics(here("mapping_demo", "images", "twitter_purrr.png"))
```
:::
...
knitr::include_graphics(here("mapping_demo", "images", "Geospatial_R.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "GIS.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "Why-is-ArcGIS-So-Expensive.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "programmer_meme.jpg"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "vector.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "forest_cover.jpg"))
```
:::
...
knitr::include_graphics(here("mapping_demo", "images", "cont_vs_cat.png"))
```
:::
...
knitr::include_graphics(here("mapping_demo", "images", "sf-relations.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "sf-area.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "new-terra.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "cube1.png"))
```
:::
...
knitr::include_graphics(here("mapping_demo", "images", "layering.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "grammar-of-graphics.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "ggplot_plots.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "EAB_map.png"))
```
...
knitr::include_graphics(here("mapping_demo", "images", "emerald-ash-borer-on-leaf.png"))
```
:::
