...
knitr::include_graphics("./images/datum_v_proj.gif")
```

## Why is the CRS important?

-   Provide a framework for precisely measuring locations on earth's
    surface\
-   You'll get errors or mistakes when using inconsistent CRS\
-   For example, distances will vary, and overlaid features won't match
